...
import { BACKEND_ERROR_CODE, createFlatRequest, createRequest } from '@na/axios';
...
import { getBackendErrorMessage } from './backend-error';
...
export const request = createFlatRequest<App.Service.Response, RequestInstanceState>(
  ...
  },
  {
    ...
    async onBackendFail(response, instance) {
      ...
      const backendMsg = getBackendErrorMessage(responseCode);
...
export const demoRequest = createRequest<App.Service.DemoResponse>(
  ...
  },
  {
    ...
    isBackendSuccess(response) {
      // when the backend response code is "100000", it means the request is success
