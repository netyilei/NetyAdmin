...
const backendErrorI18nKeyMap: Record<string, string> = {
  ...
  [BackendErrorCode.requestTimeout]: 'request.backend.requestTimeout',
  ...
  [BackendErrorCode.passwordTooWeak]: 'request.backend.passwordTooWeak',
