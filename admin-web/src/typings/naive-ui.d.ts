declare namespace NaiveUI {
  ...
  type TableData = import('@/typings/api/v1/common').Common.CommonRecord<object>;
  ...
  type TableApiFn<T = any, R = any> = (
    params: R
  ) => Promise<FlatResponseData<import('@/typings/api/v1/common').Common.PaginatingQueryRecord<T>>>;
