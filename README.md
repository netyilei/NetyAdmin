...
- **无 User 版本（不包含 user 模块）源码**:
    - 维护分支（不包含 user 模块，长期维护）: https://github.com/netyilei/NetyAdmin/tree/maint-nouser
    - 基线 Tag（不包含 user 模块，固定版本快照）: https://github.com/netyilei/NetyAdmin/tree/v0.1.0-nouser
- **默认账号**: `admin`
- **默认密码**: `admin123`
...
*   [Admin 基座：状态码与前端 i18n 映射](docs/admin_base_status_codes.md)
