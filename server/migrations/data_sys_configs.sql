...
VALUES 
('cache_switches', 'rbac_auth', 'true', 'boolean', 'RBAC权限与菜单总开关', TRUE, 1, 1),
('cache_switches', 'sys_config', 'true', 'boolean', '系统全局配置逻辑总开关', TRUE, 1, 1),
...
('task_config', 'retention_days', '30', 'number', '任务日志保留天数', TRUE, 1, 1),
-- 日志维护配置
('ops_config', 'retention_days', '90', 'number', '操作日志保留天数', TRUE, 1, 1),
('error_config', 'retention_days', '180', 'number', '错误日志保留天数', TRUE, 1, 1)
