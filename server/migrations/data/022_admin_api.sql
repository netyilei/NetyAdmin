...
DECLARE
    ...
    BEGIN
        ...
        IF menu_menu_id IS NOT NULL THEN
            ...
            (menu_menu_id, '获取按钮权限树', 'GET', '/admin/v1/systemManage/getButtonTree', '获取角色授权时的按钮权限树', '1', NOW(), NOW()),
            (menu_menu_id, '获取API权限树', 'GET', '/admin/v1/systemManage/getApiTree', '获取角色授权时的API权限树', '1', NOW(), NOW()),
    ...
    IF dict_menu_id IS NOT NULL THEN
        ...
        (dict_menu_id, '更新字典数据', 'PUT', '/admin/v1/system/dict/data', '更新现有字典数据项', '1', NOW(), NOW()),
    ...
    IF banner_item_menu_id IS NOT NULL THEN
        ...
        (banner_item_menu_id, '更新Banner项', 'PUT', '/admin/v1/content/banner-items', '更新现有项', '1', NOW(), NOW()),
