...
func NewDictService(dictRepo dictRepo.DictRepository, cacheMgr cache.LazyCacheManager) DictService {
	return &dictService{
		dictRepo: dictRepo,
		cacheMgr: cacheMgr,
	}
...
func (s *dictService) CreateType(ctx context.Context, t *dictEntity.DictType) error {
	return s.dictRepo.CreateType(ctx, t)
}

func (s *dictService) UpdateType(ctx context.Context, t *dictEntity.DictType) error {
...
func (s *dictService) CreateData(ctx context.Context, d *dictEntity.DictData) error {
...
func (s *dictService) UpdateData(ctx context.Context, d *dictEntity.DictData) error {
