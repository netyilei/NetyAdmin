...
type Error struct {
	...
	Fingerprint    string    `gorm:"column:fingerprint;size:64;index;comment:错误指纹" json:"fingerprint"`
	OccurCount     int64     `gorm:"column:occur_count;default:1;comment:发生次数" json:"occurCount"`
